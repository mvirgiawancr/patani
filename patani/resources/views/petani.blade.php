  ...
  <header>
    <div class="container-fluid">
      <div class="row py-3 border-bottom">
        ...
        <div class="col-sm-8 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                ...
                <div class="nav nav-tabs-atas" id="nav-tab" role="tablist">
                  ...
                  <a class="nav-link-atas active  " id="produk-tab" data-bs-toggle="tab" href="#kelola-produk" role="tab" aria-controls="kelola-produk" aria-selected="true">Kelola Produk</a>
                  <a class="nav-link-atas " id="pesanan-tab" data-bs-toggle="tab" href="#kelola-pesanan" role="tab" aria-controls="kelola-pesanan" aria-selected="false">Kelola Pesanan</a>
                </div>
              </div>
            </div>
        </div>
                    ...
                    <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                      ...
                      <div class="col">
                        <div class="product-item">
                          <figure>
                            <a href="#" title="{{ $item->nama_produk }}">
                              <img src="{{ asset('storage/produk_images/1736866369_Screenshot_20221217_131249.jpg') }}" class="tab-image">
                            </a>
                          </figure>
        ...
        <div class="modal-body">
          ...
          <form id="addProductForm" method="POST" action="{{ route('produk.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="number" step="0.01" class="form-control border border-2" id="harga_produk" name="harga_produk" required>
            </div>
            <!-- Deskripsi -->
            <div class="mb-3">
              <label for="deskripsi" class="form-label">Deskripsi</label>
              <textarea class="form-control border border-2" id="deskripsi" name="deskripsi" rows="3" required></textarea>
            </div>
            <!-- Stok -->
            <div class="mb-3">
